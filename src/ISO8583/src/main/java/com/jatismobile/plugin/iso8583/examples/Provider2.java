...
public class Provider2 {
	...
	void run() throws Exception {
		try {
			...
			providerSocket = new ServerSocket(1425, 100);
...
//			String tt = "0210723A40010AC180040605350238000000000000000001081714450381381714450108010960210300866823539118800DEVELJTS200900100800000133JTL53L31423456789714222222222204E949DE1913A10381384897EDEF24EAFA9DAD8C615BC0592AD304F927307DF48B\"@%'M$, MY.NAME^& TST#03R1  0000022003600505151106111            0600020001000000000050000000";
			String tt = "0210723A40010AC180040605350238000000000000000012151046289560871046281215121660210300872212095459900DEVELJTS200900100800000133JTL53L31423456789551444444444401B0D8BDFAB419956087B74AD75E6FF08926D58BBC81A6D596B4FE4BA4CE20B28INDAH PUTRI              I3  0000543213600285151106021222222      060000";
...
//			else if (isoMsg.getString(3).toString().equals("171000") || isoMsg.getString(3).toString().equals("172000")) {
...
//				String tt = "0210723A40010AC180080606400217000000000021500008301222027093851222410830083160120300894132932088300DEVJATIS200900100800000180000108213113300   Test' halo3bln.               4ACA80D5CC85C9D3F5F09B0AFAE1C45E30000100000000000704A       000000051000703A       000000082000702A       00000008100020170830122309360001 ";
				String tt = "0210723A40010AC1800C0605350217100000000010000012151048099560871048091215121660210300879140387170200DEVELJTS200900100800000255JTL53L31423456789551444444444401B0D8BDFAB419956087B74AD75E6FF080MUP210Z5575FD5259742D54C50F001100112233INDAH PUTRI              I3  0000543210200000000002000000000020000102041200000999792000009896920000096990112000001000023461280114234567895201712151048113600285151106021222222      060000057Token \"TMP\" : 9542 6732 9878 2346 1252 Kompensasi   5 KWh";
...
//				resp.set(63, "JTSMOBILE                       INFORMASI TEKNOLOGI INDONESIA Jl. Mampang Prapatan No.3 Jakarta 12790           0217940946        3174");
			...
			else if (isoMsg.getString(3).toString().equals("172000")) {
				resp.setPackager(packager);
				String tt = "0230723A40010AC1800C0605350217200000000010000012151137029560871137021215121660210300880522878146900DEVELJTS200900100800000255JTL53L31423456789551444444444401B0D8BDFAB419956087B74AD75E6FF080MUP210Z5575FD5259742D54C50F001100112233INDAH PUTRI              I3  0000543210200000000002000000000020000102041200000999792000009896920000096990112000001000023461280114234567895201712151137053600285151106021222222      060000059Informasi Hubungi Call Center 321 Atau hubungi PLN Terdekat";
				resp.unpack(tt.getBytes());
				System.out.println("TRX_AMOUNT : " + resp.getString(4));
				System.out.println("field data : " + resp.getString(48) + resp.getString(60) + resp.getString(61));
				resp.set(7, new SimpleDateFormat("MMddHHmmss").format(date));
...
//			 out.write("0200623A400108C1800006134003380000061411053289049011053206140615601203008675813758656DEVJATIS200900100800000018888880125679873305360".getBytes());
	...
	public static void main(String args[]) throws Exception {
		Provider2 server = new Provider2();
		while (true) {
			server.run();
		}
	}
