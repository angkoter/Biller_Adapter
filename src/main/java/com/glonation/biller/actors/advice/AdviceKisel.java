...
public class AdviceKisel extends UntypedActor {
	private static final Logger logger = LoggerFactory.getLogger(AdviceKisel.class);
	...
	public AdviceKisel(Map<String, Map<String, Map<String, Object>>> abc, ActorSystem system, AdapterSettings as) {
		this.as = as;
		this.abc = abc;
		this.system = system;
	}
	...
	public void onReceive(Object message) {
		if (message instanceof CamelMessage) {
			...
			try {
				...
				logger.debug(TAG + "Request to Biller MAP :" + mapRequestTemplate);
				...
				responseToCore.put("BILLER_REAL_RESPONSE", stringResponseBiller);
				...
				if(mapResponseFromBiller.containsKey("error")){
					...
					if(tempErrorCode[1].equalsIgnoreCase("12")){
